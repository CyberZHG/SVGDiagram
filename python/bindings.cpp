...
PYBIND11_MODULE(_core, m, py::mod_gil_not_used()) {
    ...
    py::class_<SVGEdge, shared_ptr<SVGEdge>>(m, "SVGEdge")
        .def(py::init<>())
        .def_property_readonly_static("SPLINES_LINE", [](py::object) { return std::string(SVGEdge::EDGE_SPLINES_LINE); })
        .def_property_readonly_static("SPLINES_SPLINE", [](py::object) { return std::string(SVGEdge::EDGE_SPLINES_SPLINE); })
        .def_property_readonly_static("ARROW_NONE", [](py::object) { return std::string(SVGEdge::ARROW_SHAPE_NONE); })
        .def_property_readonly_static("ARROW_NORMAL", [](py::object) { return std::string(SVGEdge::ARROW_SHAPE_NORMAL); })
        .def_property_readonly_static("ARROW_EMPTY", [](py::object) { return std::string(SVGEdge::ARROW_SHAPE_EMPTY); })
