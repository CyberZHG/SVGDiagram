...
<g class="edge" id="edge1">
  <title>A->B</title>
  <path d="M 81.96777431615375 102.40429675784617 C 59.97314526346146 105.33691396487181 -65.22051442665283 112.60156557545295 -50 120 C -34.77948557334717 127.39843442454705 136.07571739672557 142.32908608760707 161.84554346096385 145.52121699228212" fill="none" stroke="black"/>
  <polygon points="171.78660246886372,146.62750267526786 161.46084831021125,149.00001211783524 162.23506047865018,142.04295846573214 171.78660246886372,146.62750267526786" fill="black" stroke="black"/>
</g>)s";
    compareSVGWithDefaultGraphContent(svg, expected);
    const ::testing::TestInfo* info = ::testing::UnitTest::GetInstance()->current_test_info();
    diagram.render(format("{}_{}.svg", info->test_suite_name(), info->name()));
...
<g class="edge" id="edge1">
  <title>A->B</title>
  <path d="M 70.5137022423649 103.59446714149539 C 59.97314526346146 105.33691396487181 -65.22051442665283 112.60156557545295 -50 120 C -34.77948557334717 127.39843442454705 136.07571739672557 142.32908608760707 173.2908608760707 146.79490330512849" fill="none" stroke="black"/>
  <polygon points="80.46233523021301,102.56072400947616 70.87761706446182,107.07549727987623 70.15415573825156,100.11298309967681 80.46233523021301,102.56072400947616" fill="black" stroke="black"/>
</g>)s";
    compareSVGWithDefaultGraphContent(svg, expected);
    const ::testing::TestInfo* info = ::testing::UnitTest::GetInstance()->current_test_info();
    diagram.render(format("{}_{}.svg", info->test_suite_name(), info->name()));
...
<g class="edge" id="edge1">
  <title>A->B</title>
  <path d="M 70.5137022423649 103.59446714149539 C 59.97314526346146 105.33691396487181 -65.22051442665283 112.60156557545295 -50 120 C -34.77948557334717 127.39843442454705 136.07571739672557 142.32908608760707 161.84554346096385 145.52121699228212" fill="none" stroke="black"/>
  <polygon points="80.46233523021301,102.56072400947616 70.87761706446182,107.07549727987623 70.15415573825156,100.11298309967681 80.46233523021301,102.56072400947616" fill="black" stroke="black"/>
  <polygon points="171.78660246886372,146.62750267526786 161.46084831021125,149.00001211783524 162.23506047865018,142.04295846573214 171.78660246886372,146.62750267526786" fill="black" stroke="black"/>
</g>)s";
    compareSVGWithDefaultGraphContent(svg, expected);
