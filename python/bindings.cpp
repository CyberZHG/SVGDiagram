...
PYBIND11_MODULE(_core, m, py::mod_gil_not_used()) {
    ...
    py::class_<SVGNode, shared_ptr<SVGNode>>(m, "SVGNode")
        .def(py::init<>())
        .def_property_readonly_static("SHAPE_NONE", [](py::object) { return std::string(SVGNode::SHAPE_NONE); })
        .def_property_readonly_static("SHAPE_CIRCLE", [](py::object) { return std::string(SVGNode::SHAPE_CIRCLE); })
        .def_property_readonly_static("SHAPE_DOUBLE_CIRCLE", [](py::object) { return std::string(SVGNode::SHAPE_DOUBLE_CIRCLE); })
        .def_property_readonly_static("SHAPE_RECT", [](py::object) { return std::string(SVGNode::SHAPE_RECT); })
        .def_property_readonly_static("SHAPE_ELLIPSE", [](py::object) { return std::string(SVGNode::SHAPE_ELLIPSE); })
    ...
    py::class_<SVGEdge, shared_ptr<SVGEdge>>(m, "SVGEdge")
        .def(py::init<>())
        .def_property_readonly_static("SPLINES_LINE", [](py::object) { return std::string(SVGEdge::SPLINES_LINE); })
        .def_property_readonly_static("SPLINES_SPLINE", [](py::object) { return std::string(SVGEdge::SPLINES_SPLINE); })
        .def_property_readonly_static("ARROW_NONE", [](py::object) { return std::string(SVGEdge::ARROW_NONE); })
        .def_property_readonly_static("ARROW_NORMAL", [](py::object) { return std::string(SVGEdge::ARROW_NORMAL); })
        .def_property_readonly_static("ARROW_EMPTY", [](py::object) { return std::string(SVGEdge::ARROW_EMPTY); })
