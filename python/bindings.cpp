...
PYBIND11_MODULE(_core, m, py::mod_gil_not_used()) {
    ...
    py::class_<SVGNode, shared_ptr<SVGNode>>(m, "SVGNode")
        ...
        .def("set_style", &SVGNode::setStyle, py::arg("style"))
        .def("append_style_dashed", &SVGNode::appendStyleDashed)
        .def("append_style_dotted", &SVGNode::appendStyleDotted)
    ;
    py::class_<SVGEdge, shared_ptr<SVGEdge>>(m, "SVGEdge")
        ...
        .def("set_style", &SVGEdge::setStyle, py::arg("style"))
        .def("append_style_dashed", &SVGEdge::appendStyleDashed)
        .def("append_style_dotted", &SVGEdge::appendStyleDotted)
    ...
    py::class_<SVGGraph, shared_ptr<SVGGraph>>(m, "SVGGraph")
        ...
        .def("set_style", &SVGGraph::setStyle, py::arg("style"))
        .def("append_style_dashed", &SVGGraph::appendStyleDashed)
        .def("append_style_dotted", &SVGGraph::appendStyleDotted)
