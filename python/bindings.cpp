...
PYBIND11_MODULE(_core, m, py::mod_gil_not_used()) {
    ...
    py::class_<SVGNode, shared_ptr<SVGNode>, SVGItem>(m, "SVGNode")
        ...
        .def_property_readonly_static("SHAPE_TRIANGLE", [](py::object) { return string(SVGNode::SHAPE_TRIANGLE); })
        .def_property_readonly_static("SHAPE_PENTAGON", [](py::object) { return string(SVGNode::SHAPE_PENTAGON); })
        ...
        .def_property_readonly_static("SHAPE_DIAMOND", [](py::object) { return string(SVGNode::SHAPE_DIAMOND); })
        .def_property_readonly_static("SHAPE_INV_TRIANGLE", [](py::object) { return string(SVGNode::SHAPE_INV_TRIANGLE); })
        .def_property_readonly_static("SHAPE_INV_TRAPEZIUM", [](py::object) { return string(SVGNode::SHAPE_INV_TRAPEZIUM); })
        .def_property_readonly_static("SHAPE_INV_HOUSE", [](py::object) { return string(SVGNode::SHAPE_INV_HOUSE); })
