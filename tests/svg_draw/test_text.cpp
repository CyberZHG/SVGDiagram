...
TEST(TestSVGDrawText, TwoLinesAutoSize) {
  ...
  <tspan x="0" dy="-0.6em">Hello&#160;world!</tspan><tspan x="0" dy="1.2em">世界你好！</tspan>
    ...
    diagram.addSVGDraw(std::move(text));
    svg = diagram.render();
    expected = R"s(<svg width="116.8" height="46.8" viewBox="0 0 116.8 46.8" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
  <!-- Generated by: https://github.com/CyberZHG/SVGDiagram -->
  <g id="graph0" class="graph" transform="translate(58.4,23.4) scale(1.0)">
    <rect x="-58.4" y="-23.4" width="116.8" height="46.8" fill="white"/>
...
TEST(TestSVGDrawText, ThreeLinesAutoSize) {
  ...
  <tspan x="0" dy="-1.2em">Hello&#160;world!</tspan><tspan x="0" dy="1.2em">世界你好！</tspan><tspan x="0" dy="1.2em">Salve,&#160;mundus!</tspan>
    ...
    diagram.addSVGDraw(std::move(text));
    svg = diagram.render();
    expected = R"s(<svg width="133.6" height="63.6" viewBox="0 0 133.6 63.6" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
  <!-- Generated by: https://github.com/CyberZHG/SVGDiagram -->
  <g id="graph0" class="graph" transform="translate(66.8,31.8) scale(1.0)">
    <rect x="-66.8" y="-31.8" width="133.6" height="63.6" fill="white"/>
    <text x="0" y="0" text-anchor="middle" dominant-baseline="central" font-family="Times,serif" font-size="14">
      <tspan x="0" dy="-1.2em">Hello&#160;world!</tspan><tspan x="0" dy="1.2em">世界你好！</tspan><tspan x="0" dy="1.2em">Salve,&#160;mundus!</tspan>
    </text>
  </g>
